...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for i in string.ascii_lowercase:
            shift_dict[i] = lowercase[lowercase.find(i)+shift]
        
        uppercase = string.ascii_uppercase*2
        for i in string.ascii_uppercase:
            shift_dict[i] = uppercase[uppercase.find(i)+shift]
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        for i in range(26):
            ...
            if counter > highest:
                highest = counter
                shift_and_decryptedMessage = (26-i,decrypted_message)
            
        return shift_and_decryptedMessage
...
#    #Example 1 test case (PlaintextMessage)
#    plaintext1 = PlaintextMessage('abcdef', 2)
#    print('Expected Output: cdefgh')
#    print('Actual Output:', plaintext1.get_message_text_encrypted())
#    
#    #Example 2 test case (PlaintextMessage)
#    plaintext2 = PlaintextMessage('Why Yes', 4)
#    print('Expected Output: Alc Ciw')
#    print('Actual Output:', plaintext2.get_message_text_encrypted())
#
#
#    #Example 1 test case (CiphertextMessage)
#    ciphertext1 = CiphertextMessage('cdefgh')
#    print('Expected Output:', (24, 'abcdef'))
#    print('Actual Output:', ciphertext1.decrypt_message())
#    
#    #Example 2 test case (CiphertextMessage)
#    ciphertext2 = CiphertextMessage('Alc Ciw')
#    print('Expected Output:', (22, 'Why Yes'))
