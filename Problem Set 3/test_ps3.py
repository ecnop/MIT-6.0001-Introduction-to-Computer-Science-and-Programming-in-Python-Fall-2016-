...
# manual test of get_word_score
#
score = get_word_score("f*x",4)
print(score)
...
# manual test of test_update_hand
#
#word = ''
#hand = {'h':1,'b':2,'c':3,'o':1,'l':1,'a':2}
...
# manual test of is_valid_word
        
#word1 = 'hi'
#word2 = 'gas'
#hand = {'h':1,'b':2,'i':1}
#print(is_valid_word(word1, hand, word_list))
#print(is_valid_word(word1, hand, word_list))

# end of test_is_valid_word


# manually testing dealing a hand with an asterisk

#hand = deal_hand(10)
#print(hand)

# end of manual test of dealing a hand
...
# manual test of calculate_handlen(hand)
#        
hand = {'a':3,'b':50}
print(calculate_handlen(hand))

# end of manual test of calculate_handlen(hand)


# manual test of play_hand(hand, word_list)
#        
#hand = {'a':1,'j':1,'e':1,'f':1,'*':1,'r':1,'x':1}
hand = {'a':1,'w':1,'n':1,'i':1,'*':1,'t':1,'x':1,'d':1}
play_hand(hand,word_list)
#       
# end of manual test of play_hand(hand, word_list)
        
        
# manual test of substitute_hand(hand, letter)
#        
#hand = {'a':3,'b':50}
#letter = 'b'
...
#
#
# end of manual test of substitute_hand(hand, letter)
